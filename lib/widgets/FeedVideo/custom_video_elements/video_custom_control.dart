...
class CustomControlVideo extends StatefulWidget {
  const CustomControlVideo({
  ...
  State<StatefulWidget> createState() {
    return _CustomControlVideoState();
  }
}

class _CustomControlVideoState extends State<CustomControlVideo>
  ...
  GestureDetector _buildExpandButton(Color backgroundColor, Color iconColor,
    ...
    return GestureDetector(
      onTap: () {
        onTap == null ? _onExpandCollapse() : onTap();
      },
      child: AnimatedOpacity(
        opacity: notifier.hideStuff ? 0.0 : 1.0,
        duration: const Duration(milliseconds: 300),
  ...
  Widget _buildHitArea(Function onDoubleTapAction) {
    ...
    return GestureDetector(
      ...
      onDoubleTap: () { 
        onDoubleTapAction != null ? onDoubleTapAction() : null;
      },
        ...
        children: <Widget>[
          if (chewieController.allowFullScreen)
            _buildExpandButton(
                ...
                onTap: widget.onDoubleTapAction != null
                    ? () {
                        widget.onDoubleTapAction!();
                      }
                    : null),
