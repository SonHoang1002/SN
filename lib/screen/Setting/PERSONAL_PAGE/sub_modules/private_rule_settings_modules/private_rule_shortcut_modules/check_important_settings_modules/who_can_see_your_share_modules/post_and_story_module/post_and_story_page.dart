...
import 'package:social_network_app_mobile/screen/Setting/PERSONAL_PAGE/sub_modules/private_rule_settings_modules/private_rule_shortcut_modules/check_important_settings_modules/who_can_see_your_share_modules/block_page.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: const [
            BackIconAppbar(),
            AppBarTitle(title: PostAndStoryConstants.POST_AND_STORY_APPBAR_TITLE),
            SizedBox(),
          ],
        ),
      ),
                          ...
                          widget: Container(
                            ...
                            child: Column(children: [
                              buildTextContent(
                                  ...
                                  false,colorWord: Colors.grey[300]),
                              SizedBox(
                                height: 10,
                              ),
                              ElevatedButton(
