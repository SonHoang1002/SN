...
class RecruitInterested extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<RecruitInterested> createState() => _RecruitInterestedState();
}

class _RecruitInterestedState extends ConsumerState<RecruitInterested> {
  late double width;
  late double height;
    ...
    Future.delayed(Duration.zero, () {
      if (mounted) {
        ref
            ...
            .getListRecruitInterest(paramsConfigList);
      }
    });
  }
