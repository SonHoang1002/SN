...
class HowPeopleCanFindYouOnFacebookCommons {
  ...
  //   "3 Cảm ơn bạn đã xem lại cách mọi người có thể tìm thấy bạn trên Facebook. Bạn có thể thay đổi bất kỳ lúc nào trong phần cài đặt.",
  //   "4 Cảm ơn bạn đã xem lại các cài đặt dữ liệu trênFacebook. Bạn có thể thay đổi bất kỳ lúc nào trong phân cài đặt."
  // ];
  static const ALL_COMPLETED_SUBTITLE =
      "Cảm ơn bạn đã xem lại cách mọi người có thể tìm thấy bạn trên Facebook. Bạn có thể thay đổi bất kỳ lúc nào trong phần cài đặt.";
  static const Map<String, dynamic> ALL_COMPLETED_CONTENTS =HOW_PEOPLE_CAN_FIND_YOU_ON_FACEBOOK_CONTENTS;
...
class PhoneAndEmailCommons {
  ...
  static const Map<String, dynamic> PHONE_AND_EMAIL_TIP = {
    ...
    "data": {
      "icon": SettingConstants.PATH_ICON + "bell_icon.svg",
      "title":
          "Mẹo: Do có nhiều người trùng tên nhau nên chúng tôi cung cấp một vài cách để mọi người tìm thấy nhau trên Facebook."
    }
  };
...
class SearchToolCommons {
  ...
  static const SEARCH_TOOL_TITLE = [
    ...
    "Nếu bạn tắt tùy chọn này, mọi người vẫn có thể tìm thấy trang cá nhân của bạn trên Facebook bằng cách tìm kiếm tên bạn.",
  ];
...
class AllCompletedFindsCommons {
