...
import 'package:social_network_app_mobile/screens/MarketPlace/screen/buyer_orders/information_order_page.dart';
import 'package:social_network_app_mobile/screens/MarketPlace/screen/buyer_orders/success_order_page.dart';
...
class _MyOrderPageState extends ConsumerState<MyOrderPage> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      await ref.read(orderProvider.notifier).getBuyerOrder();
    });
    _filteredOrderData =
        OrderProductMarketConstant.ORDER_PRODUCT_MARKET_TAB_LIST.map(
      (e) {
