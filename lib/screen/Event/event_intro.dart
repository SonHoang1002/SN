                          ...
                          children: [
                            ClipRRect(
                              borderRadius: const BorderRadius.only(
                                  ...
                                  topRight: Radius.circular(15)),
                              child: ImageCacheRender(
                                path: eventsSuggested[indexSuggest]['banner']
                                    ['url'],
                                height: 180.0,
                                width: MediaQuery.of(context).size.width * 0.6,
                              ),
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  GetTimeAgo.parse(
                                    DateTime.parse(eventsSuggested[indexSuggest]
                                        ['start_time']),
                                  ),
                                  style: const TextStyle(
                                    fontSize: 12.0,
                        ...
                        buttonCard: Row(
                          children: [
                            Align(
                              ...
                              child: InkWell(
                                onTap: () {
                                  String key = eventsSuggested[indexSuggest]
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      color: eventsSuggested[indexSuggest]
                                                      ['event_relationship']
                                                  ['status'] !=
                                              ''
                                          ? secondaryColor
