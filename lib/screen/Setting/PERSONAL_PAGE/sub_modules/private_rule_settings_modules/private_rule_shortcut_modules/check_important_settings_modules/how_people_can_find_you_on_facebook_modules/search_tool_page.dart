    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: const [
            BackIconAppbar(),
            AppBarTitle(title: SearchToolCommons.SEARCH_TOOL_APPBAR_TITLE),
            SizedBox(),
          ],
        ),
      ),
      ...
      body: GestureDetector(
        ...
        child: Column(children: [
              ...
              child: ListView(
                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: SearchToolCommons.SEARCH_TOOL_TITLE.length,
                    itemBuilder: ((context, index) {
                      return Padding(
                        padding: const EdgeInsets.only(top: 10.0),
                        child: buildTextContent(
                          SearchToolCommons.SEARCH_TOOL_TITLE[index], false,
                          fontSize: 16,
                  ...
                  Row(
                    ...
                    children: [
                      Flexible(
                        flex: 8,
                        child: buildTextContent(
                          SearchToolCommons.SEARCH_TOOL_LINK_PERSONAL_PAGE,
                          false,
                          fontSize: 16,
                          // colorWord: Colors.grey[200]
                        ),
          ...
          buildBottomNavigatorDotWidget(
              ...
              3,
              3,
              PhoneAndEmailCommons.ADD_FRIEND_REQUEST_NEXT,
