...
import 'package:social_network_app_mobile/screen/Setting/PERSONAL_PAGE/sub_modules/private_rule_settings_modules/private_rule_shortcut_modules/check_important_settings_modules/how_to_protect_your_account_modules/password_page.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: const [
            BackIconAppbar(),
            AppBarTitle(title: LoginWarningCommons.LOGIN_WARNING_APPAR_TITLE),
            SizedBox(),
          ],
        ),
      ),
      ...
      body: GestureDetector(
        ...
        child: Column(children: [
          ...
          // navigator
          buildBottomNavigatorDotWidget(context, 3, 1, "Bỏ qua", PasswordPage()),
