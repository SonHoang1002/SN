...
class _EventInviteState extends ConsumerState<EventInvite> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero,
        () => ref.read(eventControllerProvider.notifier).getListInviteHost());
  }
                      ...
                      ? SizedBox(
                          ...
                          itemBuilder: (context, indexInteresting) {
                            String statusEvent = events[indexInteresting]
                                    ['event']['event_relationship']['status'] ??
                                '';
                                                                ...
                                                                List.generate(
                                                                    ...
                                                                    (indexGes) =>
                                                                        GestureDetector(
                                                                          onTap:
                                                                              () {
                                                                            ref.read(eventControllerProvider.notifier).updateStatusInvite(events[indexInteresting]['event']['id'], {
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            leading:
                                                                                Icon(iconEventCare[indexGes]['icon'], color: Colors.black),
                                                                            title:
                                                                                Text(iconEventCare[indexGes]['label'], style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600)),
                                                                            trailing: Radio(
                                ...
                                child: CardComponents(
                                  ...
                                  imageCard: ClipRRect(
                                    borderRadius: const BorderRadius.only(
                                        ...
                                        topRight: Radius.circular(15)),
                                    child: ImageCacheRender(
                                      path: eventsInviteHost[indexHost]
                                          ['event']['banner']['url'],
                                    ),
                                  ),
                                  onTap: () {
                                                                ...
                                                                List.generate(
                                                                    ...
                                                                    (indexGes) =>
                                                                        GestureDetector(
                                                                          onTap:
                                                                              () {
                                                                            ref.read(eventControllerProvider.notifier).updateStatusInviteHost(eventsInviteHost[indexHost]['event']['id'], {
                                                                              'status': iconEventHost[indexGes]['key']
                                                                            });
                                                                            Navigator.pop(context);
                                                                          },
                                                                          child:
                                                                            ...
                                                                            visualDensity:
                                                                                const VisualDensity(horizontal: -4, vertical: -1),
                                                                            title:
                                                                                Text(iconEventHost[indexGes]['label'], style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600)),
                                                                            trailing: Radio(
