...
import 'package:social_network_app_mobile/screen/Setting/PERSONAL_PAGE/sub_modules/private_rule_settings_modules/private_rule_shortcut_modules/check_important_settings_modules/how_people_can_find_you_on_facebook_modules/phone_and_email_page.dart';
...
import '../who_can_see_what_you_share_modules/who_can_see_what_you_share_commons.dart';
import 'how_people_can_find_you_on_facebook_commons.dart';
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: const [
            BackIconAppbar(),
            AppBarTitle(
                title: AddFriendRequestCommons.ADD_FRIEND_REQUEST_APPBAR_TITLE),
            SizedBox(),
          ],
        ),
      ),
      ...
      body: GestureDetector(
        ...
        child: Column(children: [
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  // title
                  buildTextContent(
                      AddFriendRequestCommons.ADD_FRIEND_REQUEST_TITLE, true,
                      fontSize: 16),
                  SizedBox(
                    height: 5,
                  ),
                  ...
                  GeneralComponent(
                    [
                      buildTextContent(
                        AddFriendRequestCommons.ADD_FRIEND_REQUEST_TIP["data"]
                            ["title"],
                        false,
                        fontSize: 16,
          ...
          buildBottomNavigatorDotWidget(
              ...
              3,
              1,
              AddFriendRequestCommons.ADD_FRIEND_REQUEST_NEXT,
              PhoneAndEmailPage()),
