...
class RecruitNewsPast extends ConsumerStatefulWidget {
  const RecruitNewsPast({super.key});

  @override
  ConsumerState<RecruitNewsPast> createState() => _RecruitNewsPastState();
}

class _RecruitNewsPastState extends ConsumerState<RecruitNewsPast> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      if (mounted) {
        ref
            ...
            .getListRecruitNewPast(paramsConfigList);
      }
    });
    scrollController.addListener(() {
      if (scrollController.position.maxScrollExtent ==
        ...
        String maxId =
            ref.read(recruitControllerProvider).recruitsNewPast.last['id'];
        ref
            .read(recruitControllerProvider.notifier)
            .getListRecruitNewPast({"max_id": maxId, ...paramsConfigList});
      }
    });
  }
