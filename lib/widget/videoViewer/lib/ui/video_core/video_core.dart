...
import 'package:social_network_app_mobile/widget/videoViewer/lib/domain/entities/volume_control.dart';
import 'package:social_network_app_mobile/widget/videoViewer/lib/ui/overlay/overlay.dart';
import 'package:social_network_app_mobile/widget/videoViewer/lib/ui/video_core/widgets/ad.dart';
import 'package:social_network_app_mobile/widget/videoViewer/lib/ui/video_core/widgets/aspect_ratio.dart';
import 'package:social_network_app_mobile/widget/videoViewer/lib/ui/video_core/widgets/buffering.dart';
import 'package:social_network_app_mobile/widget/videoViewer/lib/ui/video_core/widgets/forward_and_rewind/bar.dart';
import 'package:social_network_app_mobile/widget/videoViewer/lib/ui/video_core/widgets/forward_and_rewind/forward_and_rewind.dart';
import 'package:social_network_app_mobile/widget/videoViewer/lib/ui/video_core/widgets/forward_and_rewind/layout.dart';
import 'package:social_network_app_mobile/widget/videoViewer/lib/ui/video_core/widgets/orientation.dart';
import 'package:social_network_app_mobile/widget/videoViewer/lib/ui/video_core/widgets/player.dart';
import 'package:social_network_app_mobile/widget/videoViewer/lib/ui/video_core/widgets/subtitle.dart';
import 'package:social_network_app_mobile/widget/videoViewer/lib/ui/video_core/widgets/thumbnail.dart';
import 'package:social_network_app_mobile/widget/videoViewer/lib/ui/video_core/widgets/volume_bar.dart';
...
import '../overlay/widgets/background.dart';
    ...
    if (!controller.isShowingSettingsMenu) {
      Misc.delayed(50, () {
        if (_canListenerMove(controller)) {
          setState(() {
            _closeVolumeStatus?.cancel();
            _showVolumeStatus = false; // turn off volume bar
          });
        }
      });
    }
