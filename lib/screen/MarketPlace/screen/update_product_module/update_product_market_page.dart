...
class _UpdateProductMarketPageState
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            buildTextContent(
                              ...
                              pushToNextScreen(
                                  context, UpdateInformationMarketPage());
                            })
                          ],
                        ),
                        buildSpacer(height: 10),
  ...
  validateForUpdateProduct() async {
    print("update: _validatorSelectionList : ${_validatorSelectionList}");
    ...
    if (_formKey.currentState!.validate() &&
      ...
      // print("update: product_images : ${product_images}");
