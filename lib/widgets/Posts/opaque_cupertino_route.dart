...
///  * [CustomOpaqueCupertinoPageRoute], which is a [PageRoute] that leverages this mixin.
mixin CupertinoRouteTransitionMixin<T> on PageRoute<T> {
  ...
  /// The title string of the previous [CustomOpaqueCupertinoPageRoute].
  ///
  ...
  /// is not a [CustomOpaqueCupertinoPageRoute].
  ///
  /// See also:
  ///
  ...
  ///
  /// Used by [CustomOpaqueCupertinoPageRoute.buildTransitions].
  ///
  /// This method can be applied to any [PageRoute], not just
  /// [CustomOpaqueCupertinoPageRoute]. It's typically used to provide a Cupertino style
...
class CustomOpaqueCupertinoPageRoute<T> extends PageRoute<T>
...
// A page-based version of CustomOpaqueCupertinoPageRoute.
//
// This route uses the builder from the page to build its content. This ensures
// the content is up to date after page updates.
class _PageBasedCustomOpaqueCupertinoPageRoute<T> extends PageRoute<T>
    with CupertinoRouteTransitionMixin<T> {
...
/// See also:
///
///  * [CustomOpaqueCupertinoPageRoute], for a [PageRoute] version of this class.
class CupertinoPage<T> extends Page<T> {
  ...
  Route<T> createRoute(BuildContext context) {
    return _PageBasedCustomOpaqueCupertinoPageRoute<T>(
...
///
/// This is created by a [CustomOpaqueCupertinoPageRoute] in response from a gesture caught
