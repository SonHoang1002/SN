...
void main()
{
	...
	vec3 mix1 = blendScreen(bg.rgb,screenColor.rgb);
	vec3 mix2 = blendLinearDodge(mix1,dodgeColor.rgb);
	bnb_FragColor = vec4(blendNormal(mix1, normalColor.rgb,normalColor.a),1.);
