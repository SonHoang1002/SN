...
const growPriceTitle = [
  ...
  },
  {
    "id": 1,
    "title": "Đầu tư",
    "subTitle": "Đầu tư cho dự án để hưởng những ưu đãi và lợi nhuận đã được cam kết",
    "type": "invest_project",
  },
  {
    "id": 2,
    "title": "Nhắn tin",
    "subTitle": "Chúng tôi không chịu trách nhiệm khi nhà đầu tư liên hệ trực tiếp và đầu tư không thông qua nền tảng EMSO",
  },
];
                                            ...
                                            showModalBottomSheet(
                                                ...
                                                builder: (context) => SizedBox(
                                                      ...
                                                      child:  ListView.builder(
                                                        itemCount: growPriceTitle.length,
                                                        itemBuilder: (BuildContext context, int indexTitle) {
                                                          return ListTile(
                                                            title:  Text('${growPriceTitle[indexTitle]['title']}', style: const TextStyle(
                                                                          ...
                                                                          showModalBottomSheet(
                                                                              ...
                                                                              builder: (context) =>
                                                                                  SingleChildScrollView(
                                                                                    ...
                                                                                    child: ModalDonate(
                                                                                        data:
                                                                                            growDetail, dataModal: growPriceTitle[indexTitle]),
                                                                                  )) : null;
                                                            },
                                                          );
                                                        },
                                        ...
                                        InkWell(
                                          onTap: () {
                                            ...
                                            if(growButtonFollower) {
                                              ref
                                                  .read(growControllerProvider.notifier)
                                                  .updateStatusGrow(growDetail['id'], false);
                                            } else {
                                              ref
                                                  .read(growControllerProvider.notifier)
                                                  .updateStatusGrow(growDetail['id'], true);
                                            }
                                            setState(() {
                                              growButtonFollower = !growButtonFollower;
                                            });
                                          },
                                          child: Container(
                                              height: 30,
                      ...
                      child: Container(
                        ...
                        child: Align(
                          ...
                          child: Row(
                                ...
                                children: growButton.map((button) {
                                  return Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        border: Border.all(
                                            width: 0.2, color: greyColor)),
                                    width: button['label'] == '' ? MediaQuery.of(context).size.width * 0.1  : button['label'] == 'Ủng hộ' ? MediaQuery.of(context).size.width * 0.4 : MediaQuery.of(context).size.width * 0.3,
                                    child: InkWell(
                                      onTap: () {},
                                      child: button['label'] == ''
                                          ? Icon(
                                        ...
                                        size: 16.0,
                                          ...
                                          : Align(alignment: Alignment.center, child: Text(button['label'], textAlign: TextAlign.center,)),
                                    ),
                                  );
                                }).toList(),
                              ),
                              ...
                              //     mainAxisAlignment: MainAxisAlignment.spaceAround,
                              //       children: [
                              //     Text('${growButton[indexButton]['label']}', style: const TextStyle(color: Colors.white)),
                              //     Icon(iconEventCare[indexButton]['icon'], color: Colors.white),
                              //   ]),
                              //   )]);
          ...
          child: Column(
            ...
            children: [
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Container(
                        decoration: BoxDecoration(
                          color: secondaryColor.withOpacity(0.2),
                          borderRadius: BorderRadius.circular(16),
                          border: selectedItemIndex == index  ? Border.all(
                            width: 1, color: greyColor) : null
                        ),
                        child: InkWell(
                          onTap: () {
                              setState(() {
              ...
              Padding(
                ...
                child: InkWell(
                  onTap: () {
                    var value = '${!_isCustomize && selectedItemIndex != -1 ?  growPrice[selectedItemIndex]['value'] : controller.text}';
                      ...
                      showCupertinoDialog(
                        ...
                        builder: (BuildContext context) {
                          return CupertinoAlertDialog(
                            title: const Text('Xác nhận thanh toán', style: TextStyle(fontWeight: FontWeight.w700)),
                            content: Padding(
                              ...
                              child: RichText(
                                text: TextSpan(
                                  children: [
                                    TextSpan(
                                        text: 'Bạn có chắc muốn ${dataModal['title'].toString().toLowerCase()} dự án với ${!_isCustomize && selectedItemIndex != -1 ? growPrice[selectedItemIndex]['value'] : controller.text }',
                                    ...
                                    WidgetSpan(
                                      child: Padding(
                                        ...
                                        child: SvgPicture.asset('assets/IconCoin.svg',
                                            width: 14, height: 14, color: secondaryColor),
                                      ),
                                    ),
                                  ],
                                ),
                              ...
                              CupertinoDialogAction(
                                ...
                                onPressed: () {
                                  ref.read(growControllerProvider.notifier).updateTransactionDonate({
                                    ...
                                    "detail_type":
                                    "${dataModal['type'].toString()}"
                                  }, growDetail['id']);
                                  Navigator.of(context)..pop()..pop();
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text('${dataModal['title'].toString()} dự án thành công'),
...
class  RechargeModal extends ConsumerStatefulWidget {
  final dynamic data;
  const RechargeModal ({super.key, this.data, });
  @override
