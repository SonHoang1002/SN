    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: const [
            BackIconAppbar(),
            AppBarTitle(title: BlockCommons.BLOCK_APPBAR_TITLE),
            SizedBox(),
          ],
        ),
      ),
      ...
      body: GestureDetector(
        ...
        child: Column(children: [
                  ...
                  GeneralComponent(
                    ...
                    suffixWidget: ElevatedButton(
                      ...
                      child: buildTextContent("Bo chan", true,
                          colorWord: Colors.white, fontSize: 15),
                    ),
                    suffixFlexValue: 10,
                    changeBackground: Colors.grey[100],
                  ),
                ],
              ),
            ),
          ...
          // navigator
          buildBottomNavigatorDotWidget(context, 3, 3, "Tiep tuc", AllCompletedPage(name:"who_can_see_what_you_share" ,)),
