...
class _ReactionsBoxState extends State<ReactionsBox>
  ...
  Widget renderBox() {
    return Opacity(
      ...
      child: Container(
        ...
        // margin: EdgeInsets.only(
        //   top: isDragging
        //       ? (previousIconFocus == 0 ? zoomBoxIcon.value : 20.0)
        //       : isDraggingOutside
  ...
  void onTapReactionIcon(TapUpDetails details) {
  ...
  void onHorizontalDragUpdateBoxIcon(DragUpdateDetails dragUpdateDetail) {
    ...
    print("reaction topPosition ${topPosition}");
    print("reaction bottomPosition ${bottomPosition}");
    print(
        "reaction dragUpdateDetail.globalPosition.dy ${dragUpdateDetail.globalPosition.dy}");

    if (dragUpdateDetail.globalPosition.dy >= topPosition - 75 &&
        dragUpdateDetail.globalPosition.dy <=
            bottomPosition + (bottomPosition < 200 ? 170 : 40)) {
      isDragging = true;
      isDraggingOutside = false;
