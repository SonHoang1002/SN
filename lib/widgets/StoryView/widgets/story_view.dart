...
class StoryViewState extends ConsumerState<StoryView>
  ...
  void _play() {
    ...
    int index = widget.storyItems.indexOf(storyItem);
    setState(() {
      storySelected = widget.medias[index];
    });
        ...
        return Expanded(
          child: Container(
            ...
            child: StoryProgressIndicator(
              ...
              indicatorHeight:
                  widget.indicatorHeight == IndicatorHeight.large ? 2 : 1,
              indicatorColor: widget.indicatorColor,
            ),
          ),
        );
