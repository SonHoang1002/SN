...
class _EventInviteState extends ConsumerState<EventInvite> {
  ...
  void _fetchGetListInvite() {
    ref.read(eventControllerProvider.notifier).getListInvite(paramsConfig);
  }

  void _fetchGetListInviteHost() {
                                                                      ...
                                                                      GestureDetector(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          visualDensity: const VisualDensity(
                                                                              ...
                                                                              vertical: -1),
                                                                          leading: Icon(
                                                                              iconEventCare[indexGes]['icon'],
                                                                              color: Colors.black),
                                                                          title: Text(
                                                                              iconEventCare[indexGes]['label'],
