...
import 'interact_on_social_network_page.dart';
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: const [
            BackIconAppbar(),
            AppBarTitle(
                title: InformationOnPersonalAdverCommons
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  // title
                  buildTextContent(
                    InformationOnPersonalAdverCommons
                  ...
                  ListView.builder(
                    ...
                    shrinkWrap: true,
                    itemCount: InformationOnPersonalAdverCommons
                        .INFORMATION_ON_FACEBOOK_ADVER_CONTENTS["data"].length,
                    itemBuilder: ((context, index) {
                      final data = InformationOnPersonalAdverCommons
