...
class _OrderProductMarketPageState extends State<OrderProductMarketPage> {
  ...
  int length = get_product_list_for_review.length;
  ...
  Widget build(BuildContext context) {
    ...
    colorTheme = theme.themeMode == ThemeMode.dark
      ...
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            bottom: TabBar(
              ...
              tabs: [
                Tab(
                  icon: Icon(FontAwesomeIcons.list, color: colorWord),
                  child: Text(
                    "Tất cả",
                ...
                Tab(
                    icon: Icon(FontAwesomeIcons.searchengin, color: colorWord),
                    child: Text("Đang giao (10)",
                        style: TextStyle(color: colorWord))),
                Tab(
                    icon: Icon(FontAwesomeIcons.searchengin, color: colorWord),
                    child:
                        Text("Hoàn thành", style: TextStyle(color: colorWord))),
                Tab(
                    icon: Icon(FontAwesomeIcons.searchengin, color: colorWord),
                    child: Text("Đã hủy", style: TextStyle(color: colorWord))),
                Tab(
                    icon: Icon(FontAwesomeIcons.searchengin, color: colorWord),
  ...
  Widget _buildCompleteBody() {
    return _buildBaseBody(_buildCompleteComponent());
  }
  ...
  Widget _buildCompleteComponent() {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10),
      decoration: BoxDecoration(
          color: colorTheme,
      ...
      child: Column(children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              const SizedBox(),
              buildTextContent("thanh toán (2 mục)", true,
                  fontSize: 16, colorWord: Colors.green[700]),
            ],
          ),
        ),
        buildDivider(color: red),
        ...
        Column(
          children: [
            buildButtonForMarketWidget(
                width: width, title: "Mua lại", bgColor: greyColor),
            buildButtonForMarketWidget(
                width: width,
                title: "Đánh giá",
                bgColor: blueColor,
                function: () {
                  pushToNextScreen(context, ReviewProductMarketPage());
                }),
            buildButtonForMarketWidget(
                width: width,
                title: "Xem chi tiết",
  ...
  void _showDetailDialog() {
    showBottomSheetCheckImportantSettings(
        ...
        widget: Column(children: [
          ...
          _buildBetweenContent("Doanh thu đơn hàng", "480854584",
          ...
          _buildBetweenContent("Tổng tiền sản phẩm", "3000000"),
          _buildBetweenContent("Phí vận chuyển", "1240000"),
          _buildBetweenContent("Tổng tiền thanh toán", "480854584",
              titleBold: true, colorTitle: blackColor),
        ]));
  }

// general
  Widget _buildOrderItem(int index, dynamic data) {
    data = get_product_list_for_review[index];
    return Column(
      children: [
        Padding(
            ...
            children: [
              Row(
                children: [
                  ...
                  buildTextContent("Real Madrid C.F. Việt Nam", false,
                      fontSize: 14),
                ],
              ),
              const SizedBox()
        ...
        Padding(
          ...
          child: GeneralComponent(
            [
              buildTextContent(data["title"], false, fontSize: 18),
              buildSpacer(height: 10),
            ],
            preffixFlexValue: 6,
            prefixWidget: Padding(
              ...
              child: ImageCacheRender(
                height: 100.0,
                path: data["product_image_attachments"][0]["attachment"]["url"],
              ),
            ),
            suffixFlexValue: 10,
