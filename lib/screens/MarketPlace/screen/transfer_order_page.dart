...
class _TransferOrderPageState extends ConsumerState<TransferOrderPage> {
  ...
  _buildStatusTitle(dynamic status, dynamic paymentStatus) {
    ...
    } else if (["cancel"].contains(status)) {
      statusMessage = "Giao hàng không thành công";
      color = red;
              ...
              Flexible(
                child: SingleChildScrollView(
                  ...
                  children: [
                    ...
                    widget.orderData['status'] == "shipping"
                        ? Container(
                            color: primaryColor,
                            child: GeneralComponent(
                              [
                        ...
                        : Padding(
                            ...
                            child: GeneralComponent(
                              [
                                ...
                                buildSpacer(height: 5),
                                buildTextContent(
                                    "Vận chuyển bởi Nhanh - Shoppee Xpress",
                                    false,
                                    fontSize: 13,
                                    colorWord: greyColor),
                              ],
                              ...
                              prefixWidget: Container(
                                  ...
                                  child: ImageCacheRender(
                                    path: (widget.orderData['order_items'][0]
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: widget.orderData['status'] == "shipping"
                            ? [
                                buildTextContent("Thông tin vận chuyển", false,
                                    fontSize: 16),
                                const SizedBox()
                              ]
                            : [
                    ...
                    Timeline(
                        ...
                        children: List.generate(demoDelivered.length, (index) {
                          return _buildContent(
                              ...
                              titleColor:
                                  index == 0 ? Colors.green : greyColor);
                        }).toList()),
                  ],
                )),
              ),
