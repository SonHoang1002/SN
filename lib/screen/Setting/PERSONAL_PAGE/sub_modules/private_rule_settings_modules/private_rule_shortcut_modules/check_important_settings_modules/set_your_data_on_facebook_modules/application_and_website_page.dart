...
import 'package:social_network_app_mobile/screen/Setting/PERSONAL_PAGE/sub_modules/private_rule_settings_modules/private_rule_shortcut_modules/check_important_settings_modules/set_your_data_on_facebook_modules/location_page.dart';
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: const [
            BackIconAppbar(),
            AppBarTitle(
                title: ApplicationAndWebsiteCommons
      ...
      body: GestureDetector(
        ...
        child: Column(children: [
            ...
            child: Container(
              ...
              child: ListView(
                ...
                children: [
                  // title
                  buildTextContent(
                    ApplicationAndWebsiteCommons.APPLICATION_AND_WEBSITE_TITLE,
                    false,
                    fontSize: 16,
                  ...
                  Container(
                    child: ListView.builder(
                        ...
                        shrinkWrap: true,
                        itemCount: ApplicationAndWebsiteCommons
                                      ...
                                      widget: ListView.builder(
                                          ...
                                          itemBuilder: ((context, index) {
                                            return GeneralComponent(
                                              ...
                                              suffixWidget: ApplicationAndWebsiteCommons
                                                              .APPLICATION_AND_WEBSITE_BOTTOM_SHEET_CONTENTS[
                                                          "data"][index]["icon"] !=
                                                      null
                                                  ? Container(
          ...
          buildBottomNavigatorDotWidget(
              ...
              2,
              1,
              ApplicationAndWebsiteCommons.APPLICATION_AND_WEBSITE_NEXT,
              LocationPage()),
...
//                                           ),
//                                         ),
//                                         buildTextContent(ApplicationAndWebsiteCommons
//                                                       .APPLICATION_AND_WEBSITE_CONTENTS[
